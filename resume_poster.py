...
def main():
    rabota = Rabota()
    mail = open('mails.txt').read().split('\n')
    skills = ''''
    image_path = rf'{os.getcwd()}\image.jpg'
    rabota.first_page(mail[0], phone_number, city, wanted_position, first_name, second_name)
    rabota.second_page(skills, image_path)
